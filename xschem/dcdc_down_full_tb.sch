...
N -430 -150 -430 -120 {lab=vcntl}
N -430 -60 -430 -50 {lab=GND}
N 130 -60 130 -10 {lab=GND}
N 100 -80 130 -80 {lab=#net2}
N 130 -100 130 -80 {lab=#net2}
N 100 -60 130 -60 {lab=GND}
N 100 -160 100 -100 {lab=VDD}
N -220 -100 -200 -100 {lab=#net3}
C {devices/code.sym} -400 -350 0 0 {name=TR10_MODELS
only_toplevel=true
...
C {devices/vsource.sym} -360 -90 0 0 {name=vin value=12.0 savecurrent=false}
C {devices/gnd.sym} -360 -20 0 0 {name=l4}
...
C {devices/lab_pin.sym} -360 -150 2 1 {name=p3 sig_type=std_logic lab=vin}
C {devices/vsource.sym} -290 -90 0 0 {name=vdd value=5.0 savecurrent=false}
C {devices/gnd.sym} -290 -20 0 0 {name=l3}
C {devices/vdd.sym} -290 -150 0 0 {name=l5 lab=VDD}
...
C {devices/vsource.sym} -430 -90 0 0 {name=vcntl value=5.0 savecurrent=false}
C {devices/lab_pin.sym} -430 -150 1 0 {name=p4 sig_type=std_logic lab=vcntl}
C {devices/gnd.sym} -430 -50 0 0 {name=l7 lab=GND}
C {vco.sym} -50 -80 0 0 {name=x1}
C {devices/vdd.sym} 100 -160 0 0 {name=l8 lab=VDD}
C {devices/lab_pin.sym} -220 -100 1 0 {name=p5 sig_type=std_logic lab=vcntl}
